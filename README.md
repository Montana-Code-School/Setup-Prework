...
4. Install [Homebrew](https://brew.sh/) by pasting the following code  <code>/usr/bin/ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install)"</code>  into your Terminal and pressing <kbd>Enter</kbd>
* Generate a SSH key
